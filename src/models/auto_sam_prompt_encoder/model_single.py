from src.models.auto_sam_prompt_encoder.hardnet import HarDNet
from src.models.auto_sam_prompt_encoder.base import *
...
class ModelEmb(nn.Module):
    def __init__(self, hard_net_arch, depth_wise, hard_net_cp):
        super(ModelEmb, self).__init__()
        self.backbone = HarDNet(hard_net_cp = hard_net_cp, depth_wise=depth_wise, arch=hard_net_arch)
        d, f = self.backbone.full_features, self.backbone.features
